...
LiaScript ist eine Erweiterung von Markdown. André und Sebastian haben sich an GitHub Flavored Markdown orientiert und dieses um Funktionen erweitert, die einen erweiterten Einsatz von Multimedia und Interaktionen mit Nutzenden ermöglichen.
...
Hier folgt dann der Inhalt.... Das funktioniert auch mit `<article>` statt `<section>`:
...
?[OpenScience Podcast der ZBW](https://podcast.zbw.eu/fos/2021/12/08/fos14-forschungsdatenmanagement/)


?[104 BPM Industrial Drum Loop](https://freesound.org/people/looplicator/sounds/759391/? "104 BPM Industrial Drum Loop #6085 by looplicator -- https://freesound.org/s/759391/ -- License: Attribution 4.0")
